...
// import { connectSocket, getSocket, disconnectSocket } from "@/lib/socket/chatroom-socket"
...
//   useEffect(() => {
//     // Connect to socket with username if available
//     const username = useSelector((state: any) => state.user.username) || "Guest";
//     const socket = connectSocket(username);

//     // Listen for user_joined and user_left events to refresh chatrooms
//     const handleRoomUpdate = () => {
//       dispatch(fetchUserChatrooms() as any);
//     };
//     socket.on("user_joined", handleRoomUpdate);
//     socket.on("user_left", handleRoomUpdate);

//     return () => {
//       socket.off("user_joined", handleRoomUpdate);
//       socket.off("user_left", handleRoomUpdate);
//       disconnectSocket();
//     };
//   }, [dispatch]);
          ...
          >
            <Card className="overflow-hidden">
              ...
              <CardContent>
                ...
                <Button asChild className="w-full">
                  <Link href={`/join-chatroom/${chatroom.id}`}>Join Chatroom</Link>
                </Button>
              </CardContent>
            </Card>
          </motion.div>
